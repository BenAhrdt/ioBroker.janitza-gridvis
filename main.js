							...
							for(const timeBase of Object.values(this.timeBases)){
								...
								if(timeBase.anchorstring != ""){
									...
									if(timeBase.endstring == "NAMED_Today"){
										...
										endtimestring = `EUROPEAN_${actDate.getDate()}.${actDate.getMonth() + 1}.${actDate.getFullYear() - 1} 0:10:0`;//${actDate.getUTCHours()}:${actDate.getUTCMinutes()}:${actDate.getUTCSeconds()}`;//{actDate.toLocaleTimeString()}`;
									}
